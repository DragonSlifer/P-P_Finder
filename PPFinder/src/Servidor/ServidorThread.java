...
public class ServidorThread extends Thread {
    ...
    /**
     * ****************************************************************
     * Constructor de la clase a la que se le pasa desde el modelo el numero de
     * clientes con el que se va a trabajar
     *
     * @param num_clientes
     * @param vecinos
     * @param port
    ...
    /**
     * ****************************************************************
     * Función que se encarga de permanecer a la espera de nuevas conexiones por
     * parte de los clientes hasta que se llega al numero de clientes
     * establecido.
     *
    ...
    /**
     * ****************************************************************
     * Esta función auxiliar se encarga de averiguar el grupo al que pertenece
     * el cliente que ha enviado las ultimas coordenadas recibidas
     *
     * @param id ***************************************************************
     */
    ...
    /**
     * ****************************************************************
     * Esta función auxiliar se encarga de averiguar el id del cliente que ha
     * enviado las ultimas coordenadas recibidas
     *
     * @param mensaje
     * ***************************************************************
     */
    ...
    /**
     * ****************************************************************
     * Se encarga de reenviar a todos los miembros del grupo las coordenadas del
     * cliente que envio el paquete con su posición
     *
     * @param grupo_cli
     * @param id_cli
     * @param recv_paquete
    ...
    /**
     * ****************************************************************
     * Se encarga de recibir las confirmaciones de cada uno de los vecinos del
     * grupo y de renviarlas al cliente que envio las coordenadas
     *
     * @param grupo_cli
     * @param id_cli
     * @param puerto
    ...
    /**
     * ****************************************************************
     * Se encarga de recibir el tiempo medio de cada uno de los clientes y
     * introducirlo en un vector con los tiempos de cada grupo
     * ***************************************************************
     */
    void recibirTiempos() {
        String mensaje;
    ...
    /**
     * ****************************************************************
     * Se encarga de calcular todos los tiempos que se necesitan para las
